...
def transliterate_tamil_to_roman(text):
    custom_scheme = SchemeMap(SCHEMES[sanscript.TAMIL], SCHEMES[sanscript.ITRANS])
...
def main():
    ...
    st.title("PDF Text Extractor for Tamil")
    ...
    if uploaded_file is not None:
        ...
        # Perform any Tamil-specific processing or analysis based on user input
        if user_question:
            st.header("Tamil Processing:")
